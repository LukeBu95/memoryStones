...
<header>
    ...
    <h1 class="display-1 d-none d-xl-block">STOLPERSTEINE</h1>
	<h1 class="display-3 d-none d-md-block d-xl-none">STOLPERSTEINE</h1>
	<h1 class="d-block d-md-none">STOLPERSTEINE</h1>
